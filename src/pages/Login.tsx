      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        ...
        >
          ...
          <div className="mt-8 space-y-4">
            ...
            <PremiumCard gradient="sky" className="p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="font-semibold text-sky-300 text-[13px]">Demo Mode Active </div>
              </div>
              <div className="text-sky-200/70 text-[11px] leading-relaxed">For exhibition & college demo. Simulated telemetry with premium UI. Future backend: Node.js + Express + MongoDB + Suricata + LLM analysis + Spline 3D.</div>
          ...
          <div className="mt-8 text-center flex justify-center gap-3">
            ...
            <SpinningBorderButton> UI</SpinningBorderButton>
          </div>
        </motion.div>
      </div>

      {/* Right - Preview with cards */}
